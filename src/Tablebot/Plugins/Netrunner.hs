...
import Tablebot.Utility.Netrunner
import Tablebot.Utility.Netrunner.Card (Card)
import Tablebot.Utility.Netrunner.Custom (customCard)
import Tablebot.Utility.Netrunner.NrApi (NrApi, getNrApi)
