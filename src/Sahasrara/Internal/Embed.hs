...
-- | SahasraraEmbedRequest is a request object that mimics various bits of the discord api, just so we can add colours.
...
data SahasraraEmbedRequest a where SahasraraEmbedRequest :: ChannelId -> Text -> Embed -> SahasraraEmbedRequest Message

instance Request (SahasraraEmbedRequest a) where
  jsonRequest = createEmbedJson
  majorRoute = embedMajorRoute

embedMajorRoute :: SahasraraEmbedRequest a -> String
embedMajorRoute (SahasraraEmbedRequest chan _ _) = "msg " <> show chan

createEmbedJson :: SahasraraEmbedRequest a -> JsonRequest
createEmbedJson (SahasraraEmbedRequest chan msg embed) =
