-- |
-- Module      : Sahasrara.Plugins.Netrunner.Custom
...
module Sahasrara.Plugins.Netrunner.Command.Custom (customCard) where
...
import Sahasrara.Utility.Search (FuzzyCosts (..), closestPairWithCosts, closestValue)
