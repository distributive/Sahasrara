-- |
-- Module      : Sahasrara.Plugins.Roll.Dice
...
module Sahasrara.Plugins.Roll.Dice (evalInteger, evalList, ListValues (..), defaultRoll, PrettyShow (prettyShow), integerFunctionsList, listFunctionsList, Converter (promote)) where
...
import Sahasrara.Plugins.Roll.Dice.DiceEval (PrettyShow (prettyShow), evalInteger, evalList)
import Sahasrara.Plugins.Roll.Dice.DiceFunctions (integerFunctionsList, listFunctionsList)
import Sahasrara.Plugins.Roll.Dice.DiceParsing ()
