-- |
-- Module      : Sahasrara.Plugins.Roll.Dice.DiceStats
...
-- expressions.
module Sahasrara.Plugins.Roll.Dice.DiceStats (rangeExpr, rangeListValues, getStats) where
...
import Sahasrara.Plugins.Roll.Dice.DiceEval
import Sahasrara.Plugins.Roll.Dice.DiceFunctions
import Sahasrara.Plugins.Roll.Dice.DiceStatsBase (Distribution)
import Sahasrara.Utility.Exception (catchBot)
