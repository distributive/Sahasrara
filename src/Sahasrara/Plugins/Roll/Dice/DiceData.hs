-- |
-- Module      : Sahasrara.Plugins.Roll.Dice.DiceData
...
-- `Sahasrara.Plugins.Roll.Dice` to see the regex for this and brief explanations
-- for each data type.
module Sahasrara.Plugins.Roll.Dice.DiceData where

import Data.Map as M (Map, fromList)
import Data.Text (Text)
import Data.Tuple (swap)
import Sahasrara.Plugins.Roll.Dice.DiceFunctions (FuncInfo, FuncInfoBase)
