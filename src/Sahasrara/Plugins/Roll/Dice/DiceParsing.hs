...
-- |
-- Module      : Sahasrara.Plugins.Roll.Dice.DiceParsing
...
module Sahasrara.Plugins.Roll.Dice.DiceParsing () where
...
import Sahasrara.Utility.Parser (integer, parseCommaSeparated1, skipSpace)
import Sahasrara.Utility.SmartParser (CanParse (..), (<??>))
