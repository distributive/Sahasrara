-- |
-- Module      : Sahasrara.Plugins.Roll.Dice.DiceEval
...
-- expressions.
module Sahasrara.Plugins.Roll.Dice.DiceEval (PrettyShow (prettyShow), evalList, evalInteger, evaluationException, propagateException) where
